...
class UnitOfWorkTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->gateway = new Gateway($this->connections, new QueryFactory, $this->mapper);
    ...
    public function testUpdate()
    {
        ...
        $entity = new MockEntity($select->fetchOne());
    ...
    public function testExec_success()
    {
        ...
        $select = $this->gateway->select();
        $select->where('name = ?', 'Anna');
        $coll[1] = new MockEntity($select->fetchOne());
        ...
        $coll[2] = new MockEntity($select->fetchOne());

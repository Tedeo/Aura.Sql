...
use Aura\Sql\AbstractConnection;
...
class Select extends AbstractQuery
{
    ...
    protected function toString()
    {
        ...
        $this->connection->appendLimit($text, $this->limit, $this->offset);
    ...
    {
        return $this->connection->fetchAll($this->__toString(), $this->getBind());
    }
    ...
    {
        return $this->connection->fetchAssoc($this->__toString(), $this->getBind());
    }
    ...
    {
        return $this->connection->fetchCol($this->__toString(), $this->getBind());
    }
    ...
    {
        return $this->connection->fetchValue($this->__toString(), $this->getBind());
    }
    ...
    {
        return $this->connection->fetchPairs($this->__toString(), $this->getBind());
    }
    ...
    {
        return $this->connection->fetchOne($this->__toString(), $this->getBind());
    }
}
